            ...
            <form onSubmit={saveCategory}>
                ...
                {properties.length > 0 && properties.map((property,index) => (
                    <div className="flex gap-1 mb-2"> 
                        <input type="text" className="mb-0" value={property.name} onChange={ev => handlePropertyNameChange(index,property,ev.target.value)} placeholder="property name (exemple: color)" />
            ...
            <tr key={category._id}>
              ...
              <td>
                ...
                <button
                  ...
                  className="btn-red mr-1">Delete</button>
              </td>
            </tr>
          ))}
          </tbody>
